            ...
            @foreach(auth()->user()->clients as $client)
                <div class="bg-[#F8F8F8] m-4 p-4 ml-0 rounded-xl flex justify-around">
                    <div class="my-auto rounded">
                        <img class="rounded h-16 w-16 object-cover" src="{{ Storage::url($client->photo) }}"
            ...
            <a href="{{route('client.create')}}" class="bg-white border-4 border-[#F8F8F8] m-4 p-4 mr-0 rounded-xl flex justify-around cursor-pointer">
                    ...
                    <div class="my-auto mr-auto ml-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="31.185" height="25.969"
                            ...
                            <g id="Icon_feather-user-plus" data-name="Icon feather-user-plus"
                               transform="translate(-0.25 -3.25)">
                                <path id="Path_130" data-name="Path 130"
                                      d="M21.058,30.323V27.715A5.215,5.215,0,0,0,15.842,22.5H6.715A5.215,5.215,0,0,0,1.5,27.715v2.608"
                                      transform="translate(0 -2.354)" fill="none" stroke="#000" stroke-linecap="round"
                                      stroke-linejoin="round" stroke-width="2.5"/>
                                <path id="Path_131" data-name="Path 131"
                                      d="M17.181,9.715A5.215,5.215,0,1,1,11.965,4.5a5.215,5.215,0,0,1,5.215,5.215Z"
                                      transform="translate(-0.686)" fill="none" stroke="#000" stroke-linecap="round"
                                      stroke-linejoin="round" stroke-width="2.5"/>
                                <path id="Path_132" data-name="Path 132" d="M30,12v7.823"
                                      transform="translate(-3.727 -0.981)" fill="none" stroke="#000"
                                      stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"/>
                                <path id="Path_133" data-name="Path 133" d="M33.323,16.5H25.5"
                                      transform="translate(-3.138 -1.569)" fill="none" stroke="#000"
                                      stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"/>
                            </g>
                        </svg>
                    </div>
